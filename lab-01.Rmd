...
**NA means missing value and we are seeing this result in the previous question because if a calculation involves a missing value it will automatically return a missing value as well.**
...
```{r Ex_n}
visitors_with_nations %>% 
  mutate(change=(n_2022-n_2021)/n_2021) %>% 
